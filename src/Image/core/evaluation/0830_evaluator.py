...
from ..models.wood_net import WoodNet
from ..datasets.wood_dataset import WoodDataset
...
class ModelEvaluator:
        ...
        if model_config.get('num_class', 0) == 0:
            ...
            if 'test_dataset' in checkpoint_dir.lower():
                ...
                if os.path.exists(dataset_path):
                    ...
                    print(f"Auto-detected {len(class_dirs)} classes from dataset: {class_dirs}")
                else:
    ...
    def predict_batch_images(self, image_paths: List[str]) -> List[Dict[str, Any]]:
        ...
        for image_path in image_paths:
            try:
                ...
                print(f"Processed: {os.path.basename(image_path)} -> Class: {result['predicted_class']}, Confidence: {result['confidence']:.4f}")
    ...
    def visualize_prediction(self, 
        ...
        cv2.putText(vis_img, pred_text, (20, text_y), 
                   cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 2)
        
        # Confidence
        conf_text = f"Confidence: {result['confidence']:.4f}"
        cv2.putText(vis_img, conf_text, (20, text_y + 30), 
                   cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 2)
        ...
        cv2.putText(vis_img, "Class Probabilities:", (20, prob_text_y), 
        ...
        for i, class_idx in enumerate(sorted_indices[:5]):  # Show top 5
            ...
            cv2.putText(vis_img, prob_text, (30, prob_text_y + 30 + i * 25), 
