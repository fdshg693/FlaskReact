...
from core.datasets.wood_dataset import WoodDataset
...
class TestBaseDataset:
    ...
    def test_init(self):
        ...
        dataset = MockDataset(
            path="/test/path", num_class=5, img_size=224, custom_param="test"
        )

        assert dataset.dataset_path == "/test/path"
    ...
    def test_get_dataset_info(self):
        ...
        dataset = MockDataset(
            "/test/path", num_class=3, img_size=256, custom_param="test"
        )
...
class TestWoodDataset:
    ...
    def test_getitem_without_augmentation(self, temp_dataset_dir):
        ...
        dataset = WoodDataset(
            temp_dataset_dir, num_class=3, img_size=64, augmentation=False
        )
    ...
    def test_random_crop(self, temp_dataset_dir):
        ...
        dataset = WoodDataset(
            temp_dataset_dir, num_class=1, img_size=64, augmentation=False
        )
    ...
    def test_get_dataset_info(self, temp_dataset_dir):
        """Test get_dataset_info method."""
        dataset = WoodDataset(
            temp_dataset_dir, num_class=3, img_size=128, augmentation=True
        )
    ...
    def test_backward_compatibility_alias(self, temp_dataset_dir):
        ...
        from core.datasets.wood_dataset import Wood_Dataset
...
class TestDatasetIntegration:
    ...
    def test_dataset_with_dataloader(self, sample_dataset_dir):
        ...
        dataset = WoodDataset(
            sample_dataset_dir, num_class=3, img_size=64, augmentation=False
        )
    ...
    def test_dataset_class_weights_calculation(self, sample_dataset_dir):
        ...
        dataset = WoodDataset(sample_dataset_dir, num_class=3, augmentation=False)
