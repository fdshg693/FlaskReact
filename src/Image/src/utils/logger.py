...
class Logger:
    ...
    def _initialize_csv(self) -> None:
        ...
        if not os.path.exists(self.csv_file):
            headers = [
                ...
                'best_loss', 'best_acc', 'learning_rate', 'elapsed_time'
            ]
    ...
    def save_numpy_logs(self, 
                       train_losses: List[float],
                       train_accs: List[float],
                       val_losses: List[float],
                       val_accs: List[float],
                       best_losses: List[float],
                       best_accs: List[float]) -> None:
        ...
        """
        log_array = np.vstack([
            train_losses, train_accs, val_losses,
            val_accs, best_losses, best_accs
        ]).T
    ...
    def create_summary(self, 
        ...
        self.log_info(f"Total Training Time: {total_time:.2f} seconds ({total_time/3600:.2f} hours)")
