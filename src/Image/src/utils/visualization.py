...
class Visualizer:
    ...
    def plot_training_curves(self, 
                           ...
                           save_name: str = "training_curves") -> np.ndarray:
    ...
    def plot_confusion_matrix(self, 
                            ...
                            normalize: bool = True,
                            save_name: str = "confusion_matrix") -> np.ndarray:
        ...
        cm_normalized = cv2.normalize(cm, None, alpha=0, beta=255, 
                                    norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_8U)
        heatmap = cv2.applyColorMap(
            cv2.resize(cm_normalized, None, fx=50, fy=50, 
    ...
    def create_learning_rate_plot(self, 
                                learning_rates: List[float],
                                losses: List[float],
                                save_name: str = "learning_rate_plot") -> None:
    ...
    @staticmethod
    def numpy_to_cv2_display(img_array: np.ndarray, 
