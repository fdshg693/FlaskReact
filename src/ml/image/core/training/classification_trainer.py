...
class ClassificationTrainer(BaseTrainer):
    ...
    def validate_epoch(
        self, val_loader: DataLoader, show_sample: bool = False
        ...
        if (
            ...
            and sample_predictions is not None
        ):
        ...
        return (
            metrics_calc.get_average_loss(),
            metrics_calc.get_accuracy(),
            detailed_metrics,
        )
    ...
    def fit(
        ...
        epochs: int,
        dataset_for_augmentation: Optional[Any] = None,
    ) -> Dict[str, Any]:
            ...
            if self.logger:
                ...
                if epoch % 100 == 0 or is_best_acc:
                    self.logger.log_metrics(
                        detailed_metrics, f"Epoch {epoch} Validation"
                    )
